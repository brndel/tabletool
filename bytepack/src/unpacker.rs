use crate::{PackerFormat, Unpack, pack_pointer::PackPointer};
...
impl<'b> ByteUnpacker<'b> {
    ...
    pub fn fields<'f>(&self, format: &'f PackerFormat, offset: u32) -> FieldUnpacker<'b, 'f> {
        FieldUnpacker {
